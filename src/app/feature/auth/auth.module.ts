...
import { FormAssignPasswordModalComponent } from './components/form-assign-password-modal/form-assign-password-modal.component';
...
@NgModule({
  declarations: [
    FormAssignPasswordModalComponent,
